...
class ControladorEquipoTest {
    ...
    public void obtenerEquipoKo() {
        ...
        Assertions.assertThrows(NullPointerException.class, () -> {
            doReturn(Optional.empty()).when(repositorioEquipo).findById(null);
            Optional<ResponseEntity> equipoRetornado = Optional.ofNullable(controladorEquipo
                    .obtenerEquipo(null));
        });
